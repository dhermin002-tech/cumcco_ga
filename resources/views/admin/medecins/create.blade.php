                ...
                <form method="POST" action="{{ route('admin.medecins.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="jours_horaires" rows="3"
                                  class="w-full bg-paper border border-[#D8D6CF] rounded-[10px] px-4 py-[11px] text-[14.5px] text-navy hover:border-primary focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors resize-y">{{ old('jours_horaires') }}</textarea>
